...
public abstract class BaseCmsCommentExt  implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8283598552215930562L;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof CmsCommentExt)) return false;
		else {
			CmsCommentExt cmsCommentExt = (CmsCommentExt) obj;
