...
public class WebErrors extends AbstractWebErrors {
	...
	/* (non-Javadoc)
	 * @see com.leixl.easyframework.web.AbstractWebErrors#getErrorPage()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.leixl.easyframework.web.AbstractWebErrors#getErrorAttrName()
	 */
	@Override
